...
rider = get_rider(athlete_id=189040, tour="tdf", year=2023, grand_tours_db_path=DB_PATH_2, training_db_path=DB_PATH_1)
...
# full_df = create_training_dataframe(fetch_riders(DB_PATH_2, "tdf", 2024), DB_PATH_2, DB_PATH_1)
